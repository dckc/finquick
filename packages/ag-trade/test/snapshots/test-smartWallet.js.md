# Snapshot report for `test/test-smartWallet.js`

The actual snapshot is saved in `test-smartWallet.js.snap`.
      ...
      '["http://localhost:26657",{"method":"POST","body":"{\\"jsonrpc\\":\\"2.0\\",\\"id\\":244401194,\\"method\\":\\"abci_query\\",\\"params\\":{\\"path\\":\\"/cosmos.auth.v1beta1.Query/Account\\",\\"data\\":\\"0a2d61676f7269633161337a753561717732353571307475787a793961667476676865656b77327765647a33787771\\",\\"prove\\":false}}","headers":{"Content-Type":"application/json"}}]' => {
        ...
        result: {
          response: {
            ...
            log: '',
            proofOps: null,
            value: 'Cp8BCiAvY29zbW9zLmF1dGgudjFiZXRhMS5CYXNlQWNjb3VudBJ7Ci1hZ29yaWMxYTN6dTVhcXcyNTVxMHR1eHp5OWFmdHZnaGVla3cyd2VkejN4d3ESRgofL2Nvc21vcy5jcnlwdG8uc2VjcDI1NmsxLlB1YktleRIjCiEC4YomNap2bl1JGl4oNR1DEa+fVBiEPQlECpIVLhAS6AkYDyAK',
          },
        },
      },
      '["http://localhost:26657",{"method":"POST","body":"{\\"jsonrpc\\":\\"2.0\\",\\"id\\":219214959,\\"method\\":\\"abci_query\\",\\"params\\":{\\"path\\":\\"/cosmos.tx.v1beta1.Service/Simulate\\",\\"data\\":\\"\\",\\"prove\\":false}}","headers":{"Content-Type":"application/json"}}]' => {
        ...
        result: {
          response: {
            ...
            log: '',
            proofOps: null,
            value: '',
          },
        },
      },
      '["http://localhost:26657",{"method":"POST","body":"{\\"jsonrpc\\":\\"2.0\\",\\"id\\":722766156,\\"method\\":\\"status\\",\\"params\\":{}}","headers":{"Content-Type":"application/json"}}]' => {
        ...
        result: {
          ...
          sync_info: {
            ...
            latest_app_hash: 'C2949709272A56F53B32C79D41C29724BBABE0D875E22147145670B17603997C',
            latest_block_hash: 'F012B1315F134C3BD45044B10BD4AF363A67040679CE2AD2D3049CA9F439432F',
                    ...
                    attributes: [
                      {
                        index: true,
                        key: 'YWNjX3NlcQ==',
                        value: 'YWdvcmljMWEzenU1YXF3MjU1cTB0dXh6eTlhZnR2Z2hlZWt3MndlZHozeHdxLzEw',
                      },
                    ],
                    type: 'tx',
                  },
                    ...
                    attributes: [
                      {
                        index: true,
                        key: 'c2lnbmF0dXJl',
                        value: 'WCs1YVhVcXpmSy9KcEVRTm5mYnJoaEhiOXM4ZCs5NXNiVlFrSWRVNXRtWXpYdXB3TStKUWhmNUJUa2xSOGEwZUd4bVVocy80ZzNYcWFtOU40L1Jqa3c9PQ==',
                      },
                    ],
                    type: 'tx',
                  },
            ...
            signatures: [
              {
                ...
                signature: 'Vjuh+RXznsZoGpFKdlEDjCdlVVdcuHpcxoIu5QwKS1KBjgJeLI7nQlUM1i1vT046nrbRXgwnN1zWug/mBXzrAw==',
